(function (angular) {
  ...
  function authService($q, $http, session, $state, jwtHelper){
    ...
    function getNom() {
        return tokenPayload.nom;
    }

    function getPrenom() {
        return tokenPayload.prenom;
    }

    function getTelephone() {
        return tokenPayload.telephone;
    }

    function getFamilyId() {
        return tokenPayload.familyId;
    }
  ...
  // Inject dependencies
  authService.$inject = ['$q', '$http', 'session', '$state', 'jwtHelper'];
